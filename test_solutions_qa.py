...
def simulate_format_matching(format_str):
    ...
    if "foir" in format_lower or "affordability" in format_lower:
        ...
        return "JOINT_ENGINE"
    elif "journey" in format_lower or "step by step" in format_lower or "walkthrough" in format_lower or "hub" in format_lower or "a-to-z" in format_lower or "guidance" in format_lower:
